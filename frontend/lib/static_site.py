...
class StaticSitePrivateS3(StaticSite):
    ...
    def _create_cloudfront_distribution(self):
        ...
        self.origin_access_identity = cloudfront.OriginAccessIdentity(self, 'OriginAccessIdentity')
        ...
        # self.hosted_zone.grant_delegation(self.origin_access_identity)
...
class StaticSitePublicS3(StaticSite):
    ...
    def _create_cloudfront_distribution(self):
        ...
        response_headers_policy = cloudfront.ResponseHeadersPolicy(self, "ResponseHeadersPolicy",
            response_headers_policy_name="MultiTenantRagPolicy",
